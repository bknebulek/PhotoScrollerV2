...
class PhotoScrollerV2(BaseTk):
    def __init__(self):
        super().__init__()
        self.title('Photo Scroller V2')
    ...
    def _build_ui(self):
        ...
        title = tk.Label(self.topbar, text='Photo Scroller V2', font=('Segoe UI', 13, 'bold'), fg='white', bg='#202020')
    ...
    def _build_sidebar(self):
        ...
        self._add_scale('Odstęp między zdjęciami', self.gap, 0, 250, 5, ' px')
    ...
    def _add_scale(self, label, variable, lo, hi, step, suffix='', rebuild=False):
    ...
    def _refresh_photo_list(self):
        ...
        self.status.config(text=f'{len(self.image_paths)} zdjęć')
...
if __name__ == '__main__':
    try:
        ...
        try:
            ...
            messagebox.showerror('Photo Scroller V2', f'Błąd programu:\n{exc}')
        except Exception:
            print(exc)
        sys.exit(1)
